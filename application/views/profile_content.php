...
<head>        
    ...
    <![endif]-->      
    <script type='text/javascript' src='<?php echo base_url()?>js/plugins/jquery/jquery-1.9.1.min.js'></script>
    <script type='text/javascript' src='<?php echo base_url()?>js/plugins/jquery/jquery-ui-1.10.1.custom.min.js'></script>
    <script type='text/javascript' src='<?php echo base_url()?>js/plugins/jquery/jquery-migrate-1.1.1.min.js'></script>
    ...
    <script type='text/javascript' src='<?php echo base_url()?>js/plugins/shbrush/XRegExp.js'></script>
